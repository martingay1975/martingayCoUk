...
namespace Xceed.Words.NET.Examples
{
    public class SectionSample
    {
        ...
        private static void AddPageFooters(DocX document, int section)
        {
            document.Sections[section].AddFooters();
            document.Sections[section].DifferentFirstPage = true;
            var footers3 = document.Sections[section].Footers;
            footers3.First.InsertParagraph($"This is the First page footer of Section {section}.");
            footers3.Odd.InsertParagraph($"This is the Odd page footer of Section {section}.");
            footers3.Even.InsertParagraph($"This is the Even page footer of Section {section}.");
        }
